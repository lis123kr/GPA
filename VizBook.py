...
class vizbook:
	def __init__(self, book):
		...
		self.BPRaw = book.BPRaw
		self.sheet_names = book.sheet_list
	...
	def preprocessing_(self):
		...
		assert self.BPRaw is not None, "read file first"
		self.nsheet = len(self.BPRaw)
		for bp, name in zip(self.BPRaw, self.sheet_names):
